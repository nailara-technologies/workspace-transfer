...
use strict;
use warnings;
use Text::EnhancedSelfExtractingDocument;
...
# Create an EnhancedSelfExtractingDocument object
my $doc = Text::EnhancedSelfExtractingDocument->new(steps => \@steps, state_data => $state_data);

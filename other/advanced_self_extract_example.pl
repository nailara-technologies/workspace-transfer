...
use strict;
use warnings;
use Text::AdvancedSelfExtractingDocument;
...
# Create an AdvancedSelfExtractingDocument object
my $doc = Text::AdvancedSelfExtractingDocument->new(steps => \@steps, state_data => $state_data);
